...
void ShowUsage() {
  std::cerr << "Usage: robot <online/offline/mix> options" << std::endl;
  ...
  std::cerr << std::endl;
  std::cerr << "Example 1: robot online" << std::endl;
  std::cerr << "Example 2: robot online -D hw:0,0 -d plughw:1,0" << std::endl;
}
